    ...
    <view class="login">
        <view class="login-container">
            <view class="avatar" style="display: flex; justify-content: center; align-items: center;">
                ...
                <template v-else>
                    <image class="userinfo-avatar" :src="userProfile.userInfo.avatarUrl" mode="cover"
                        @tap="bindViewTap" />
                </template>
            </view>
            <template v-if="!hasUserInfo">
            ...
            <template v-else>
                <text class="userinfo-nickname" style="display: flex; justify-content: center; align-items: center;">{{
                    userProfile.userInfo.nickName }}</text>
            </template>
            ...
            <view class="form">
                ...
                <view class="input-wrapper">
                    <nut-input class="input-item" v-model="password" placeholder="请输入密码" type="password"
                        :border="false">
                        <template #left>
                            <Find />
                        </template>
